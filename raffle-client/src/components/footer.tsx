...
import { ETHERSCAN_MUMBAI_POLYGON_TX_BASE_URL, RAFFLE_ADDRESS } from '../constants';
...
export const Footer = () => {
  return (
    <FooterContainer>
        ...
        <ContractLink href={`${ETHERSCAN_MUMBAI_POLYGON_TX_BASE_URL}${RAFFLE_ADDRESS}`} target="_blank">Fund Me Contract on Polyscan<Polygon /></ContractLink>
    </FooterContainer>
  )
}
